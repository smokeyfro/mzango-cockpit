<template>
  <Layout class="bg-white">
    <main class="p-10">
      <header>
        <h1 class="text-4xl sm:text-5xl md:text-6xl font-sans font-bold mb-1">Places</h1>
      ...
      <section class="mt-10 flex flex-wrap -mb-4">
        <post-item class="w-1/4" v-for="edge in $page.posts.edges" :key="edge.node.id" :post="edge.node" />
      </section>
