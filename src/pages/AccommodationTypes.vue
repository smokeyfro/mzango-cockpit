<template>
  <Layout class="bg-white">
    <main class="p-10">
      <header>
        <h1 class="text-4xl sm:text-5xl md:text-6xl font-sans font-bold mb-1">Accommodation Types</h1>
        <p class="text-grey-dark text-lg sm:text-3xl">Browse hosts with specific types of accommodation..</p>
      </header>
...
<page-query>
  query AccommodationTypes ($page: Int) {
    posts: allCockpitAccommodationType(page: $page, perPage: 60) @paginate {
      totalCount
      pageInfo {
        totalPages
        currentPage
