...
export default {
  ...
  methods: {
    previousPage(currentPage) {
      return [0, 1].includes(currentPage - 1) ? `${this.basePath}/journal` : `${this.basePath}/journal/${currentPage - 1}/`;
    },
    nextPage(currentPage, totalPages) {
      return totalPages > currentPage ? `${this.basePath}/journal/${currentPage + 1}/` : `${this.basePath}/journal/${currentPage}/`;
    }
  },
  computed: {
    basePath() {
